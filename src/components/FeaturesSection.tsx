...
const FeaturesSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative pb-10 overflow-hidden bg-[#f3f3f3]">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 md:gap-14">
          {featureCircles.map((feature, index) => (
            ...
            >
              <div className="w-24 h-24 sm:w-24 sm:h-24 md:w-32 md:h-32 rounded-full mb-6 overflow-hidden">
                <img 
                  src={feature.image} 
                  alt={feature.title} 
