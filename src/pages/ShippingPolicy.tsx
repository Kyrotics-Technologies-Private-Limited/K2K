...
const ShippingPolicy: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-gray-800 px-6 py-10 max-w-4xl mx-auto bg-yellow-50">
      ...
      <h2 className="text-2xl font-semibold mb-3">2. Shipping Time</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-3">4. Tracking Your Order</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-3">6. Delayed Shipment</h2>
      <p className="mb-4">
