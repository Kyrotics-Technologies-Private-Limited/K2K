...
//         setError((prev) => ({
//           ...prev,
//           product: "An unexpected error occurred",
//         }));
...
//       setError((prev) => ({ ...prev, variants: "Failed to delete variant" }));
//     }
//   };
...
//                 Base Price: ₹{product.price.amount.toFixed(2)}
//               </p>
//             </div>
//           </div>
//         </div>
...
//                         className="inline-flex items-center px-2 py-1 text-xs text-white bg-blue-500 hover:bg-blue-600 rounded"
//                       >
...
const handleEditSubmit = async (e: React.FormEvent) => {
  ...
  try {
    const updatedVariant = await variantApi.updateVariant(
      ...
      //{ ...editFormData } // payload (do NOT include productId here)
    );
